<?php
   ...
   $stmt = $conn->prepare("SELECT x.MaXe, x.BienSoXe, x.ViTriXe, x.LoaiXe, x.enableflag, l.TenLoaiXe, b.TenBenXe
                            FROM xe x 
                                    ...
                                    <td>
                                       <div class="d-flex justify-content-center">
                                          <?php 
                                             ...
                                             if ($xe['enableflag'] == 1) {
                                                echo "<a class='badge bg-danger' href='#' onclick=\"confirmDelete('xe','{$xe['MaXe']}', 0)\"> Ẩn </a>";
                                             } else {
                                                echo "<a class='badge bg-success' href='#' onclick=\"confirmDelete('xe','{$xe['MaXe']}', 1)\"> Kích hoạt </a>";
                                             }
                                          ?>
                                       </div>
                                    </td>
